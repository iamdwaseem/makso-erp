...
type Props = { data: BarChartDataPoint[]; title: string };

const COLORS = { income: "#dc2626", expense: "#0d9488" };

export function DashboardBarChart({ data, title }: Props) {
  return (
      ...
      <div className="h-[280px]">
        <ResponsiveContainer width="100%" height="100%">
          <RechartsBarChart data={data} margin={{ top: 5, right: 10, left: 0, bottom: 0 }}>
            ...
            <Tooltip formatter={(value) => [`${Number(value).toLocaleString()} AED`, ""]} contentStyle={{ fontSize: 12 }} />
