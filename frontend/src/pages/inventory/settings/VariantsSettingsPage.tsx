...
type VariantRow = { id: string; sku: string; color?: string; productId?: string; productName?: string };

export function VariantsSettingsPage() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      const res = await api.get("/variants", { params: { limit: 500 } });
