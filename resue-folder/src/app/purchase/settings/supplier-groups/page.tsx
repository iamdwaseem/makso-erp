...
import { supplierGroupsMock, type SupplierGroup } from "@/mock/purchaseSettings";

export default function SupplierGroupsSettingsPage() {
  const [list, setList] = useState<SupplierGroup[]>(supplierGroupsMock);
  ...
  return (
    <div>
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-xl font-bold text-gray-900">SUPPLIER GROUP</h1>
      ...
      {showForm && (
        <div className="mb-6 rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
          <h3 className="mb-3 text-sm font-semibold text-gray-700">New Supplier Group</h3>
