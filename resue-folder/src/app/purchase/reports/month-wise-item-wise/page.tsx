...
export default function MonthWiseItemWisePurchaseReportPage() {
  return (
    <>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <h1 className="text-xl font-bold text-gray-900">MONTH WISE ITEM WISE PURCHASE REPORT</h1>
        <div className="flex items-center gap-2">
          <input type="text" placeholder="Date range / Year" className="rounded border border-gray-200 px-3 py-1.5 text-sm" />
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 text-center text-gray-500">
        Item-wise monthly quantity and amount; columns: Item, Jan–Dec (Qty &amp; Amount), Total.
      </div>
    </>
  );
}
