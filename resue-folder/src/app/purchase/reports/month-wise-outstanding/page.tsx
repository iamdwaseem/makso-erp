...
export default function MonthWiseOutstandingReportPage() {
  return (
    <>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <h1 className="text-xl font-bold text-gray-900">MONTH WISE OUTSTANDING REPORT</h1>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 text-center text-gray-500">
        Supplier-wise outstanding amounts by month. Columns: Sl No, Supplier, monthly columns, Total Outstanding.
      </div>
    </>
  );
}
