...
import { cancelledDebitNotesRows } from "@/mock/purchaseReports";

export default function CancelledDebitNotesReportPage() {
  return (
    <>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <h1 className="text-xl font-bold text-gray-900">CANCELLED DEBIT NOTES REPORT</h1>
      ...
      <div className="overflow-x-auto rounded-lg border border-gray-200 bg-white">
        <table className="w-full text-sm">
          ...
          <tbody>
            {cancelledDebitNotesRows.map((row, i) => (
