...
import { itemWiseAdjustmentRows } from "@/mock/inventoryReports";

export default function ItemWiseInventoryAdjustmentPage() {
  return (
    <>
      <div className="mb-4 flex flex-wrap items-center gap-3">
        <h1 className="text-xl font-bold text-gray-900">ITEM WISE INVENTORY ADJUSTMENT</h1>
        <span className="text-sm text-gray-600">01-01-2021 - 31-12-2021</span>
        <span className="text-sm text-gray-600">Tirur</span>
      ...
      <div className="overflow-x-auto rounded-lg border border-gray-200 bg-white">
        <table className="w-full text-sm">
          ...
          <tbody>
            {itemWiseAdjustmentRows.map((row, i) => (
